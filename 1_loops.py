...
# # Print each subject but stop when History is reached
# # for subject in subjects:
# #     if subject == "History":
# #         break
# #     print(subject)
    
# #Skip over sicence but print out the rest of the list
# # for subject in subjects:
# #     if subject == "Science":
# #         continue
# #     print(subject)
...
#     if score < 600:
#         continue
#     print(applicant + " approved with score: " + str(score))
...
# Challenge: Sum up all numbers from range
# Print total
total = 0
